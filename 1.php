...
// query soal activity
$activity = query("SELECT * FROM activity_question");
...
// array ke-9 jawaban
$answer = ["answerAc1", "answerAc2", "answerAc3", "answerAc4", "answerAc5", "answerAc6", "answerAc7", "answerAc8", "answerAc9"];

// ambil child_id dan status melalui GET method
$child_id = $_GET["child_id"];
$status = $_GET["status"];

// cek apakah tombol Lanjut di klik
if (isset($_POST["submit1"])) {
    $_SESSION["activity"] = $_POST;
    header("Location: 2.php?child_id=".$child_id."&status=".$status);
}
  ...
  <section class="bg-white min-vh-100 mb-5">
    <div class="container pt-5 mb-3">
      <div class="alert alert-primary mt-5" role="alert">
          Bagian 1 : Activity (Berdasarkan aktivitas anak)
      </div>
    </div>
        ...
        <div class="row">
          <div class="col text-center">
            <form action="" method="post">
              ...
              <button type="submit" name="submit1" class="btn btn-primary">Lanjut &#10095;</button>
            </form>
          </div>
        </div>
      </div>
