...
// koneksi ke database
$conn = mysqli_connect("localhost", "root", "", "tes-adhd");

// buat variabel array score
$score = [];
...
// fungsi hapus child by user
function hapusChildUser($child_id, $user_id) {
	global $conn;

	$query = "DELETE FROM child WHERE child_id = $child_id AND user_id = $user_id";
	mysqli_query($conn, $query);

	return mysqli_affected_rows($conn);
}

// fungsi hitung skor activity
...
// fungsi hitung fungsi keanggotaan activity
...
// fungsi hitung fungsi keanggotaan attention
