...
// koneksi ke database
$conn = mysqli_connect("localhost", "id16726695_db_b", "5y24uFGLHtFB!dbq", "id16726695_b");
...
function registrasi($data) {
	...
	mysqli_query($conn, "INSERT INTO user VALUES(null, '$user_fullname', '$user_phone', '$username', '$password')");
...
function registrasiTes($data) {
	...
	if($ketemu) {
		...
		mysqli_query($conn, "INSERT INTO child VALUES(null, '$child_fullname', $child_age, '$child_sex', $user_id)");
...
function hitungScoreActivity($data) {
	...
	if ($status == "new") {
		$query1 = "INSERT INTO activity_answer VALUES (null, '$answer1', '$answer2', '$answer3', '$answer4', '$answer5', '$answer6', '$answer7', '$answer8', '$answer9')";
		mysqli_query($conn, $query1);
		//$activity_answer_id = mysqli_insert_id($conn);

		$query2 = "INSERT INTO activity_score VALUES (null, $scoreActivity)";
...
function hitungScoreAttention($data) {
	...
	foreach ($data as $value) {
	 ...
	 if ($status == "new") {
		$query1 = "INSERT INTO attention_answer VALUES (null, '$answer1', '$answer2', '$answer3', '$answer4', '$answer5', '$answer6', '$answer7', '$answer8', '$answer9')";
		mysqli_query($conn, $query1);

		$query2 = "INSERT INTO attention_score VALUES (null, $scoreAttention)";
		mysqli_query($conn, $query2);
...
// 	$child_id = $data["child_id"];
	...
	$query1 = "INSERT INTO answer VALUES (null, $activity_answer_id, $attention_answer_id, '$child_id')";
	mysqli_query($conn, $query1);

	$query2 = "INSERT INTO score VALUES (null, $activity_score_id, $attention_score_id, '$child_id')";
	mysqli_query($conn, $query2);
...
function output($child_id, $status) {
  ...
  //            ";
         //die;
		$query = "INSERT INTO result VALUES (null, '$final', '$final1', CURRENT_TIMESTAMP(), $child_id)";
		mysqli_query($conn, $query);
...
function report($child_id){
	...
	$query = "INSERT INTO report VALUES (null , $child_id, $score_id, $result_id, $answer_id)";
	mysqli_query($conn, $query);
	return mysqli_affected_rows($conn);
